...
| 2  | 09.10.2025     | **(0.3 балла)** Построить карту Рамачандрана для пептида из 15-20 остатков "руками", измеряя и переписывая углы в PyMOL<br /> Написать программу для измерения двугранных углов и построения scatter/contour plot для одной структуры из PDB<br /> Написать программу из п.1., применить ее на датасете из многих структур и сравнить карты Рамачандрана, построенные для разных типов остатков |
