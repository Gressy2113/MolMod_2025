...
| 2  | 09.10.2025     | 1. **(0.3 балла)** Построить карту Рамачандрана для пептида из 15-20 остатков "руками", измеряя и переписывая углы в PyMOL<br />2. **(0.7 баллов)** Написать программу для измерения двугранных углов и построения scatter/contour plot для одной структуры из PDB<br />3. **(1 балл)** Написать программу из п.1., применить ее на датасете из многих структур и сравнить карты Рамачандрана, построенные для разных типов остатков |
